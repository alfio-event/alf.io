...
import type { AdditionalField, PurchaseContextFieldDescriptionContainer } from '../../model/additional-field.ts';
  ...
  switch (field.type) {
    case 'checkbox':
      return html`
                ...
                ${repeat(
                  Object.entries(localizedConfiguration.restrictedValues ?? {}),
                  ([k]) => k,
                  ([value, label]) => html`
