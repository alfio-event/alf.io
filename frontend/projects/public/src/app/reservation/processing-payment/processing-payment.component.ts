        ...
        zip(this.route.data, this.route.params).subscribe(([data, params]) => {
            ...
            this.intervalId = setInterval(() => {
                ...
                this.reservationService
                    .getReservationStatusInfo(this.reservationId)
                    .subscribe((res) => {
                        checkCount++;
                        ...
                        if (
                            (!this.forceCheckVisible || checkCount > 120) &&
                            !this.forceCheckInProgress &&
                            checkCount % 10 === 0
                        ) {
                            this.providerWarningVisible = checkCount > 120;
                            this.forceCheckVisible =
                                !this.providerWarningVisible;
                        }
                    });
            }, 2000);
        });
