...
export class PaymentMethodSelectorComponent implements OnInit {
    ...
    constructor(
        ...
        private i8lnService: I18nService,
    ) {}
        ...
        this.overviewForm
            ...
            .valueChanges.subscribe((v) => {
                ...
                const selectedMethod =
                    this.reservationInfo.activePaymentMethods[v] || null;
                if (selectedMethod) {
                    this.overviewForm
                        .get('paymentProxy')
                        ?.setValue(selectedMethod.paymentProxy);
                }
            });

        this.reservationService
            .getApplicableCustomPaymentMethodDetails(this.reservationInfo.id)
            .subscribe((methods) => {
    ...
    get activePaymentMethods(): {
        [key: PaymentMethodId]: PaymentProxyWithParameters;
    } {
    ...
    getPaymentMethodDetails(
        ...
        const maybeCustomMethod = this.customOfflinePaymentMethods.find(
        ...
        if (maybeCustomMethod) {
            ...
            let translatedPaymentName =
                method.localizations['en']?.paymentName ||
                method.localizations[localizationKeys[0]].paymentName;
            if (Object.keys(method.localizations).includes(currentLang)) {
                translatedPaymentName =
                    method.localizations[currentLang].paymentName;
            }
