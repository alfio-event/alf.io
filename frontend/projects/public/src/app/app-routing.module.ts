...
import { type CanActivateFn, RouterModule, type Routes } from "@angular/router";
...
const routes: Routes = [
  {
    ...
    canActivate: [removeEventCss, detectLanguage],
  },
  {
    path: "o/:organizerSlug",
    component: HomeComponent,
    canActivate: [removeEventCss, detectLanguage],
  },
  {
    path: "o/:organizerSlug/events-all",
    component: EventListAllComponent,
    canActivate: [removeEventCss, detectLanguage],
  },
  {
    path: "events-all",
  ...
  },
  {
    ...
    component: SubscriptionListAllComponent,
    canActivate: [removeEventCss, detectLanguage],
  },
  {
    path: "o/:organizerSlug/subscriptions-all",
    component: SubscriptionListAllComponent,
    canActivate: [removeEventCss, detectLanguage],
  },
  {
  ...
  {
    path: "subscription/:id/reservation/:reservationId",
    data: subscriptionData,
    children: [
      {
        path: "book",
        component: BookingComponent,
        canActivate: subscriptionReservationsGuard,
      },
      {
        path: "overview",
      ...
      {
        path: "waiting-custom-payment",
        component: CustomOfflinePaymentComponent,
        canActivate: subscriptionReservationsGuard,
      },
      {
        path: "deferred-payment",
        component: DeferredOfflinePaymentComponent,
        canActivate: subscriptionReservationsGuard,
      },
      {
  ...
  {
    path: "event/:eventShortName",
    component: EventDisplayComponent,
    canActivate: [fetchEvent, detectLanguage],
    data: eventData,
  },
  {
    path: "event/:eventShortName/poll",
    loadChildren: () => import("./poll/poll.module").then((m) => m.PollModule),
    canActivate: [fetchEvent, detectLanguage],
    data: eventData,
  },
  {
    path: "event/:eventShortName/reservation/:reservationId",
    data: eventData,
    children: [
      {
        path: "book",
        component: BookingComponent,
        canActivate: eventReservationsGuard,
      },
      {
        path: "overview",
        component: OverviewComponent,
  ...
  {
    path: "event/:eventShortName/ticket/:ticketId",
    data: eventData,
    children: [
      {
        path: "view",
      ...
      {
        path: "check-in/:ticketCodeHash/waiting-room",
  ...
  },
  {
    ...
    canActivate: [userLoggedIn, removeEventCss, detectLanguage],
  },
  {
    path: "my-profile",
