...
public class TemplateResourceTest {
    ...
    public void buildModelForTicketEmail() throws Exception {
        ...
        Map<String, Object> model = TemplateResource.buildModelForTicketEmail(organization, event, ticketReservation, "Https://test", "Https://test", ticket, ticketCategory, Map.of());
