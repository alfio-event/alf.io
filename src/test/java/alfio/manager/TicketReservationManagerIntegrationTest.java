...
//        PaymentResult confirm = ticketReservationManager.performPayment(null, null, event, reservationId, "email@example.com", new CustomerName("full name", "full", "name", event), Locale.ENGLISH, "billing address",
...
//        ticketReservationManager.performPayment(null, null, event, reservationId2, "email@example.com", new CustomerName("full name", "full", "name", event), Locale.ENGLISH, "billing address",
//            totalPrice, Optional.empty(), Optional.of(PaymentProxy.OFFLINE), false, null, null, null);
//
...
//        result = ticketReservationManager.performPayment("", null, event, reservationId, "test@test.ch", new CustomerName("full name", "full", "name", event), Locale.ENGLISH, "", reservationCost, Optional.empty(), Optional.of(PaymentProxy.OFFLINE), false, null, null, null);
//        assertTrue(result.isSuccessful());
    }
}