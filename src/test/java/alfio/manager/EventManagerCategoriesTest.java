...
public class EventManagerCategoriesTest {
    ...
    void init() {
        ...
        eventManager = new EventManager(null, eventRepository, null, ticketCategoryRepository, ticketCategoryDescriptionRepository, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, TestUtil.clockProvider());
    ...
    void createTicketsForUnboundedCategory() {
        ...
        MapSqlParameterSource[] parameterSources = eventManager.prepareTicketsBulkInsertParameters(ZonedDateTime.now(ClockProvider.clock()), event, availableSeats, Ticket.TicketStatus.FREE);
