...
public class EventManagerIntegrationTest extends BaseIntegrationTest {
    ...
    private Pair<Event, String> generateAndEditEvent(int newEventSize) {
        ...
        if(newEventSize != AVAILABLE_SEATS) {
            EventModification update = new EventModification(event.getId(), Event.EventFormat.IN_PERSON, null, null, null, null, null, null, null, null, event.getOrganizationId(), null, null, null,
