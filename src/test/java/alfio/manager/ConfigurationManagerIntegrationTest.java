...
public class ConfigurationManagerIntegrationTest extends BaseIntegrationTest {
    ...
    public void testOverrideMechanism() {
        ...
        assertEquals(5, configurationManager.getFor(event, Collections.singleton(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION)).get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getValueAsInt(Integer.MIN_VALUE));
        ...
        assertEquals(6, configurationManager.getFor(event, Collections.singleton(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION)).get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getValueAsInt(Integer.MIN_VALUE));
        ...
        assertEquals(7, configurationManager.getFor(event, Collections.singleton(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION)).get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getValueAsInt(Integer.MIN_VALUE));
    ...
    public void testBulk() {
        ...
        assertEquals(5, res.get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getValueAsInt(Integer.MIN_VALUE));
        assertEquals(ConfigurationPathLevel.SYSTEM, res.get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getConfigurationPathLevel(null));
        ...
        assertEquals(ConfigurationPathLevel.ORGANIZATION, res.get(ENABLE_WAITING_QUEUE).getConfigurationPathLevel(null));
        assertEquals(ConfigurationPathLevel.ORGANIZATION, res.get(ENABLE_WAITING_QUEUE_NOTIFICATION).getConfigurationPathLevel(null));
        assertTrue(res.get(ENABLE_WAITING_QUEUE).getValueAsBoolean(false));
        assertFalse(res.get(ENABLE_WAITING_QUEUE_NOTIFICATION).getValueAsBoolean(true));
        ...
        assertEquals(ConfigurationPathLevel.EVENT, res.get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getConfigurationPathLevel(null));
        assertEquals(20, res.get(MAX_AMOUNT_OF_TICKETS_BY_RESERVATION).getValueAsInt(Integer.MIN_VALUE));
        assertEquals(ConfigurationPathLevel.EVENT, res.get(ENABLE_WAITING_QUEUE).getConfigurationPathLevel(null));
        assertEquals(ConfigurationPathLevel.EVENT, res.get(ENABLE_WAITING_QUEUE_NOTIFICATION).getConfigurationPathLevel(null));
    }
}