...
public abstract class BaseReservationFlowTest extends BaseIntegrationTest {
    ...
    protected void testBasicFlow(Supplier<ReservationFlowContext> contextSupplier) throws Exception {
        ...
        // hidden category check
        {
            ...
            var reservationInfo = reservationApiV2Controller.getReservationInfo("event", context.event.getShortName(), res.getBody().getValue());
            ...
            reservationInfo = reservationApiV2Controller.getReservationInfo("event", context.event.getShortName(), res.getBody().getValue());
            assertNotNull(reservationInfo.getBody());
        ...
        // check reservation auto creation with code: TODO: will need to check all the flows
        {
            ...
            var reservationInfo = reservationApiV2Controller.getReservationInfo("event", context.event.getShortName(), reservationId);
            assertEquals(HttpStatus.OK, reservationInfo.getStatusCode());
            assertNotNull(reservationInfo.getBody());
        ...
        //buy 2 ticket, with additional service + field
        {
            ...
            var resInfoRes = reservationApiV2Controller.getReservationInfo("event", context.event.getShortName(), reservationId);
        ...
        //buy one ticket, without discount
        {
            ...
            reservation = reservationApiV2Controller.getReservationInfo("event", context.event.getShortName(), reservationId).getBody();
            assertNotNull(reservation);
