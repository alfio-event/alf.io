...
public interface EventRepository {
    ...
    @Query("insert into event(description, short_name, website_url, website_t_c_url, location, latitude, longitude, start_ts, end_ts, time_zone, regular_price_cts, currency, available_seats, vat_included, vat, allowed_payment_proxies, private_key, org_id) " +
            "values(:description, :shortName, :websiteUrl, :termsUrl, :location, :latitude, :longitude, :start_ts, :end_ts, :time_zone, :regular_price, :currency, :available_seats, :vat_included, :vat, :paymentProxies, :privateKey, :organizationId)")
    @AutoGeneratedKey("id")
    Pair<Integer, Integer> insert(@Bind("description") String description, @Bind("shortName") String shortName, @Bind("websiteUrl") String websiteUrl, @Bind("termsUrl") String termsUrl,
    ...
    @Query("update event set description = :description, short_name = :shortName, website_url = :websiteUrl, website_t_c_url = :termsUrl, location = :location, latitude = :latitude, longitude = :longitude, start_ts = :start_ts, end_ts = :end_ts, time_zone = :time_zone, " +
            ...
            "where id = :id")
    int update(@Bind("id") int id, @Bind("description") String description, @Bind("shortName") String shortName, @Bind("websiteUrl") String websiteUrl, @Bind("termsUrl") String termsUrl,
               @Bind("location") String location, @Bind("latitude") String latitude, @Bind("longitude") String longitude, @Bind("start_ts") ZonedDateTime begin,
               @Bind("end_ts") ZonedDateTime end, @Bind("time_zone") String timeZone, @Bind("regular_price") int regular_price, @Bind("currency") String currency,
               @Bind("available_seats") int available_seats, @Bind("vat_included") boolean vat_included,
