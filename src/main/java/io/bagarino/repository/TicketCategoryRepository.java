...
public interface TicketCategoryRepository {
    ...
    @Query("insert into ticket_category(inception, expiration, name, description, max_tickets, price_cts) " +
            "values(:inception, :expiration, :name, :description, :max_tickets, :price)")
    @AutoGeneratedKey
    ...
    @Query("update ticket_category set inception = :inception, expiration = :expiration, " +
            "max_tickets = :max_tickets, price_cts = :price where id = :id")
