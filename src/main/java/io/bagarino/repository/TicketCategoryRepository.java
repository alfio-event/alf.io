...
public interface TicketCategoryRepository {
    ...
    @Query("insert into ticket_category(inception, expiration, name, description, max_tickets, discount) " +
            "values(:inception, :expiration, :name, :description, :max_tickets, :discount)")
    @AutoGeneratedKey
