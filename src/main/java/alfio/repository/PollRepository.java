...
public interface PollRepository {
    ...
    Optional<Poll> findSingleActiveInEvent(@Bind("eventId") int eventId, @Bind("id") Long pollId);
    ...
    @Query("insert into poll_option(poll_id_fk, title, description, organization_id_fk) " +
