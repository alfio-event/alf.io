...
public interface PollRepository {
    ...
    String INSERT_OPTION = """
        insert into poll_option(poll_id_fk, title, description, organization_id_fk) \
         values(:pollId, (:title)::jsonb, (:description)::jsonb, :organizationId)\
        """;

    @Query("""
        insert into poll (title, description, allowed_tags, poll_order, event_id_fk, organization_id_fk) \
    ...
    @Query("""
        update poll set title = :title::jsonb, description = :description::jsonb, allowed_tags = :allowedTags::text[],\
    ...
    @Query("""
        insert into poll_answer(poll_id_fk, poll_option_id_fk, ticket_id_fk, organization_id_fk)\
    ...
    @Query("""
        select pa.poll_option_id_fk, count(*) as votes from poll_answer pa\
