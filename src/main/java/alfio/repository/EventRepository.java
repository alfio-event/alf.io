...
public interface EventRepository {
    ...
    @Query("insert into event(description, short_name, display_name, website_url, website_t_c_url, image_url, file_blob_id, location, latitude, longitude, start_ts, end_ts, time_zone, regular_price_cts, currency, available_seats, vat_included, vat, allowed_payment_proxies, private_key, org_id, locales) " +
            "values(:description, :shortName, :displayName, :websiteUrl, :termsUrl, :imageUrl, :fileBlobId, :location, :latitude, :longitude, :start_ts, :end_ts, :time_zone, :regular_price, :currency, :available_seats, :vat_included, :vat, :paymentProxies, :privateKey, :organizationId, :locales)")
    @AutoGeneratedKey("id")
    ...
    @Query("update event set description = :description, display_name = :displayName, website_url = :websiteUrl, website_t_c_url = :termsUrl, image_url = :imageUrl, file_blob_id = :fileBlobId, " +
