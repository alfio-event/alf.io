...
public interface EventRepository {
    ...
    @AutoGeneratedKey("id")
    AffectedRowCountAndKey<Integer> insert(@Bind("description") String description, @Bind("shortName") String shortName, @Bind("websiteUrl") String websiteUrl, @Bind("termsUrl") String termsUrl, @Bind("imageUrl") String imageUrl, @Bind("fileBlobId") String fileBlobId,
