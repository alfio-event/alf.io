...
public interface TicketCategoryRepository {
    ...
    @Query("insert into ticket_category(inception, expiration, name, description, max_tickets, price_cts, access_restricted, tc_status, event_id, bounded) " +
            "values(:inception, :expiration, :name, :description, :max_tickets, :price, :accessRestricted, 'ACTIVE', :eventId, :bounded)")
    @AutoGeneratedKey("id")
