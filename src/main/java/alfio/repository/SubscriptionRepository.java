...
public interface SubscriptionRepository {
    ...
    String INSERT_SUBSCRIPTION_LINK = "insert into subscription_event(event_id_fk, subscription_descriptor_id_fk, price_per_ticket, organization_id_fk, compatible_categories)" +
    ...
    int linkSubscriptionAndEvent(@Bind("subscriptionId") UUID subscriptionId,
                                 ...
                                 @Bind("organizationId") int organizationId,
                                 @Bind("compatibleCategories") @JSONData List<Integer> compatibleCategorie);
