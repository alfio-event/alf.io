...
public interface WhitelistRepository {
    ...
    String BY_EVENT_ID = "select * from whitelist_configuration_active where  event_id_fk = :eventId";
    ...
    @Query(BY_EVENT_ID +
        ...
        " union all select * from whitelist_configuration_active where event_id_fk = :eventId and ticket_category_id_fk is null")
    ...
    @Query("select * from whitelist_configuration_active where id = :configurationId")
    ...
    @Query("update whitelist_configuration set active = false where id = :id")
