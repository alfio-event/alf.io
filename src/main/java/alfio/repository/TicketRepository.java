...
public interface TicketRepository {
    ...
    @Query("select " +
            ...
            " where t.event_id = :eventId and t.full_name is not null and t.email_address is not null and (ltu.last_update is null or ltu.last_update > :changedSince or :changedSince is null)")
