...
public interface WaitingQueueRepository {
    ...
    AffectedRowCountAndKey<Integer> insert(@Bind("eventId") int eventId, @Bind("fullName") String fullName, @Bind("emailAddress") String emailAddress, @Bind("creation") ZonedDateTime creation, @Bind("userLanguage") String userLanguage, @Bind("subscriptionType") WaitingQueueSubscription.Type subscriptionType);
