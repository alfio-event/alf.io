...
public interface WaitingQueueRepository {
    ...
    @Query("insert into waiting_queue (event_id, full_name, email_address, creation, status, user_language, subscription_type, selected_category_id) values(:eventId, :fullName, :emailAddress, :creation, 'WAITING', :userLanguage, :subscriptionType, :selectedCategoryId)")
    @AutoGeneratedKey("id")
    AffectedRowCountAndKey<Integer> insert(@Bind("eventId") int eventId, @Bind("fullName") String fullName, @Bind("emailAddress") String emailAddress, @Bind("creation") ZonedDateTime creation, @Bind("userLanguage") String userLanguage, @Bind("subscriptionType") WaitingQueueSubscription.Type subscriptionType, @Bind("selectedCategoryId") Integer selectedCategoryId);
