...
interface FieldRepository {
    ...
    @Query("update ticket_field_configuration set field_required = :required, field_restricted_values = :restrictedValues, field_disabled_values = :disabledValues where id = :id")
    int updateRequiredAndRestrictedValues(@Bind("id") int id, @Bind("required") boolean required, @Bind("restrictedValues") String restrictedValues, @Bind("disabledValues") String disabledValues);
