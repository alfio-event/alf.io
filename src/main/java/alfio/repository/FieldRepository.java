...
interface FieldRepository {
    ...
    @Query("insert into purchase_context_field_configuration(event_id_fk, organization_id_fk, field_name, field_order, field_type, field_restricted_values, field_maxlength, field_minlength, field_required, context, additional_service_id, ticket_category_ids) " +
        " values (:eventId, :organizationId, :name, :order, :type, :restrictedValues, :maxLength, :minLength, :required, :context::ADDITIONAL_FIELD_CONTEXT, :additionalServiceId, :categoryIds)")
    @AutoGeneratedKey("id")
