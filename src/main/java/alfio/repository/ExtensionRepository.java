...
public interface ExtensionRepository {
    ...
    //
    @Query("insert into extension_configuration_param_registry(ecpr_ec_identifier, ecpr_path) values (:identifier, :path)")
    @AutoGeneratedKey("ecpr_id")
    AffectedRowCountAndKey<Integer> registerExtensionParameter(@Bind("identifier") String identifier, @Bind("path") String path);

    @Query("delete from extension_configuration_param_registry where ecpr_ec_identifier = :identifier and ecpr_path = :path")
    int deleteExtensionParameter(@Bind("identifier") String identifier, @Bind("path") String path);

    @Query("insert into extension_configuration_metadata(ecm_fk_id, ecm_name, ecm_description, ecm_type, ecm_configuration_level, ecm_mandatory) " +
        " values (:ecmId, :name, :description, :type, :configurationLevel, :mandatory)")
    int registerExtensionConfigurationMetadata(@Bind("ecmId") int registryId,
                                               @Bind("name") String name,
