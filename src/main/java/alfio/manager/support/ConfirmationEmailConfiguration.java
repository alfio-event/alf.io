...
public class ConfirmationEmailConfiguration {
    ...
    public ConfirmationEmailConfiguration(TemplateResource templateResource, String emailAddress, Map<String, Object> model, List<Mailer.Attachment> attachments) {
