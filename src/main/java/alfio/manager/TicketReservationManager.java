...
public class TicketReservationManager {
    ...
    public String createTicketReservation(Event event,
        ...
        ticketReservationRepository.createNewReservation(reservationId, reservationExpiration, discount.map(PromoCodeDiscount::getId).orElse(null), locale.getLanguage(), event.getId(), event.getVat());
