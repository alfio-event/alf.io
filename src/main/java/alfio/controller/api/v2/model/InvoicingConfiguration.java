...
public class InvoicingConfiguration {
    ...
    public InvoicingConfiguration(boolean userCanDownloadReceiptOrInvoice, boolean euVatCheckingEnabled, boolean invoiceAllowed, boolean onlyInvoice, boolean customerReferenceEnabled, boolean enabledItalyEInvoicing, boolean vatNumberStrictlyRequired) {
