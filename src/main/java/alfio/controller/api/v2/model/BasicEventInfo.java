...
public class BasicEventInfo implements DateValidity {
    ...
    public BasicEventInfo(String shortName, String fileBlobId, Map<String, String> title, EventFormat format, String location, String timeZone, DatesWithTimeZoneOffset datesWithOffset, boolean sameDay, Map<String, String> formattedBeginDate, Map<String, String> formattedBeginTime, Map<String, String> formattedEndDate, Map<String, String> formattedEndTime, List<Language> contentLanguages) {
