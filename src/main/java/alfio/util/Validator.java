...
public final class Validator {
    ...
    public static class AdvancedTicketAssignmentValidator implements Function<AdvancedValidationContext, Result<Void>> {
        ...
        private final WhitelistManager.WhitelistValidator whitelistValidator;
        ...
        public Result<Void> apply(AdvancedValidationContext context) {
            ...
            return new Result.Builder<Void>()
                ...
                .checkPrecondition(() -> whitelistValidator.test(new WhitelistManager.WhitelistValidationItem(context.categoryId, context.updateTicketOwnerForm.getEmail())), ErrorCode.custom(ErrorsCode.STEP_2_WHITELIST_CHECK_FAILED, "email"))
                .build(() -> null);
        }
    }
