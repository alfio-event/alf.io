...
public final class EventUtil {
    ...
    public static BiFunction<Ticket, Event, List<TicketFieldConfigurationDescriptionAndValue>> retrieveFieldValues(TicketRepository ticketRepository,
        ...
        return (ticket, event) -> {
            ...
            Map<Long, TicketFieldDescription> descriptions = ticketFieldRepository.findTranslationsFor(LocaleUtil.forLanguageTag(ticket.getUserLanguage()), ticket.getEventId());
