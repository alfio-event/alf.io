...
public class ExtensionService {
    ...
    private static final String EVALUATE_RESULT = "res = GSON.fromJson(ExtensionUtils.convertToJson(res), returnClass);";
    ...
    private ExtensionMetadata getMetadata(String name, String script) {
        return scriptingExecutionService.executeScript(
            name,
            script + "\n;GSON.fromJson(ExtensionUtils.convertToJson(getScriptMetadata()), returnClass);", //<- ugly hack, but the interop java<->js is simpler that way...
