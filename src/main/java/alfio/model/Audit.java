...
public class Audit {
    ...
    public enum EventType {
        RESERVATION_CREATE, RESERVATION_COMPLETE, CANCEL_RESERVATION_EXPIRED, CANCEL_RESERVATION, UPDATE_EVENT, CANCEL_TICKET, REFUND, CHECK_IN, REVERT_CHECK_IN, UPDATE_TICKET
    }
