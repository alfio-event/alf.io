...
public enum ConfigurationKeys {
    ...
    GENERATE_ONLY_INVOICE("Always generate an invoice for paid reservations", false, SettingCategory.INVOICE, ComponentType.BOOLEAN, false, EnumSet.of(SYSTEM, ORGANIZATION, EVENT), Constants.FALSE),
