...
public enum ConfigurationKeys {
    ...
    ENABLE_REVERSE_CHARGE_ONLINE("Enable VAT Reverse Charge only for online tickets (if set overrides global reverse charge, default: true)", false, SettingCategory.INVOICE_EU, ComponentType.BOOLEAN, false, EnumSet.of(SYSTEM, ORGANIZATION), "true"),
    ENABLE_REVERSE_CHARGE_IN_PERSON("Enable VAT Reverse Charge only for in-person tickets (if set overrides global reverse charge, default: true)", false, SettingCategory.INVOICE_EU, ComponentType.BOOLEAN, false, EnumSet.of(SYSTEM, ORGANIZATION), "true"),
