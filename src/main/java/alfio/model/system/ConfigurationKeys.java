...
public enum ConfigurationKeys {
    ...
    HTTPS_FORCE_REDIRECT("Force HTTPS redirection (default false)", false, SettingCategory.GENERAL, ComponentType.BOOLEAN, false, EnumSet.of(SYSTEM), BooleanUtils.FALSE),
