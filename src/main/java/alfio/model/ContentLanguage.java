...
public class ContentLanguage {
    ...
    public static final ContentLanguage POLISH = new ContentLanguage(LocaleUtil.forLanguageTag("pl"),0b1000000000, LocaleUtil.forLanguageTag("pl"), "pl");

    public static final List<ContentLanguage> ALL_LANGUAGES = List.of(ENGLISH, SPANISH, ITALIAN, GERMAN, DUTCH, FRENCH, ROMANIAN, PORTUGUESE, TURKISH, POLISH);
