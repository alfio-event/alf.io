...
alter table ticket_category add column ticket_validity_start timestamp NULL DEFAULT NULL;
alter table ticket_category add column ticket_validity_end timestamp NULL DEFAULT NULL;
