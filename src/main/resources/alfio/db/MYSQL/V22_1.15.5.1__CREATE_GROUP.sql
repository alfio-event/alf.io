...
alter table group_link add foreign key group_link_a_group_id_fk (a_group_id_fk) references a_group(id);
alter table group_link add foreign key group_link_event_id_fk (event_id_fk) references event(id);
alter table group_link add foreign key group_link_ticket_category_id_fk (ticket_category_id_fk) references ticket_category(id);
...
alter table whitelisted_ticket add foreign key whitelisted_ticket_group_member_id_fk (group_member_id_fk) references group_member(id);
alter table whitelisted_ticket add foreign key whitelisted_ticket_group_link_id_fk (group_link_id_fk) references group_link(id);
