...
alter table attendee_list add foreign key attendee_list_org_id_fk (organization_id_fk) references organization(id);
...
alter table attendee_list_item add foreign key attendee_list_item_attendee_list_id_fk (attendee_list_id_fk) references attendee_list(id);
...
alter table attendee_list_configuration add foreign key attendee_list_configuration_attendee_list_id_fk (attendee_list_id_fk) references attendee_list(id);
alter table attendee_list_configuration add foreign key attendee_list_configuration_event_id_fk (event_id_fk) references event(id);
alter table attendee_list_configuration add foreign key attendee_list_configuration_ticket_category_id_fk (ticket_category_id_fk) references ticket_category(id);
...
alter table whitelisted_ticket add foreign key whitelisted_ticket_attendee_list_item_id_fk (attendee_list_item_id_fk) references attendee_list_item(id);
alter table whitelisted_ticket add foreign key whitelisted_ticket_attendee_list_configuration_id_fk (attendee_list_configuration_id_fk) references attendee_list_configuration(id);
