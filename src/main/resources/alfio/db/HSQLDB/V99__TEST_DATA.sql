...
insert into ticket_category(inception, expiration, name, max_tickets, price_cts, access_restricted, tc_status, event_id, bounded) values
  ...
  ('2014-01-10 00:00:00', '2017-10-10 00:00:00', 'Not normal', 5, 463, false, 'ACTIVE', 0, TRUE ),
  ('2016-09-10 00:00:00', '2017-10-10 00:00:00', 'Still not in sale', 1, 556, false, 'ACTIVE', 0, TRUE ),
...
insert into configuration(c_key, c_value, description) VALUES
    ...
    ('PASSBOOK_TYPE_IDENTIFIER', 'io.alf.event', 'Passbook type identifier'),
