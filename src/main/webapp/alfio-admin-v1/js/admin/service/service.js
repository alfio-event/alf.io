(function () {
    ...
    // Temporary until we migrate component that depend on AdditionalServiceManager
    baseServices.service('AdditionalServiceManager', ['$http', 'HttpErrorHandler', '$q', function($http, HttpErrorHandler, $q) {
        return {
